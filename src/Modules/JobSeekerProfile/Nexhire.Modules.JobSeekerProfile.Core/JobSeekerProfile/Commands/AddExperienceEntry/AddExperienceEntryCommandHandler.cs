...
public class AddExperienceEntryCommandHandler : ICommandHandler<AddExperienceEntryCommand>
{
    ...
    public AddExperienceEntryCommandHandler(
    ...
    public async Task<Result> Handle(AddExperienceEntryCommand request, CancellationToken cancellationToken)
    {
        ...
        var addResult = profile.AddExperience(
            request.Company,
            request.Role,
