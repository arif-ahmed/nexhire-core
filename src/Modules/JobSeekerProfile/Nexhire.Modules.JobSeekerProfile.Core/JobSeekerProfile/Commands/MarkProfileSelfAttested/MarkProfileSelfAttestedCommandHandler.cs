...
public class MarkProfileSelfAttestedCommandHandler : ICommandHandler<MarkProfileSelfAttestedCommand>
{
    private readonly IJobSeekerProfileRepository _repository;
    private readonly IUnitOfWork _unitOfWork;

    public MarkProfileSelfAttestedCommandHandler(
    ...
    public async Task<Result> Handle(MarkProfileSelfAttestedCommand request, CancellationToken cancellationToken)
    {
