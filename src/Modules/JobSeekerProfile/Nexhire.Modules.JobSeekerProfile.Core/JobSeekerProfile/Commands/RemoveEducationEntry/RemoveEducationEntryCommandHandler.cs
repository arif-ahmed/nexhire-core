...
public class RemoveEducationEntryCommandHandler : ICommandHandler<RemoveEducationEntryCommand>
{
    ...
    public RemoveEducationEntryCommandHandler(
    ...
    public async Task<Result> Handle(RemoveEducationEntryCommand request, CancellationToken cancellationToken)
    {
        ...
        var removeResult = profile.RemoveEducation(request.EducationEntryId);
