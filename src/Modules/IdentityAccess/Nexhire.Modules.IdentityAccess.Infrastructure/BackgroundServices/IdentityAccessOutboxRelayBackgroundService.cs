...
public sealed class IdentityAccessOutboxRelayBackgroundService : BackgroundService
{
    private static readonly JsonSerializerOptions JsonOptions = new(JsonSerializerDefaults.Web);
    private readonly IServiceScopeFactory _scopeFactory;
    private readonly ILogger<IdentityAccessOutboxRelayBackgroundService> _logger;

    public IdentityAccessOutboxRelayBackgroundService(
        IServiceScopeFactory scopeFactory,
        ILogger<IdentityAccessOutboxRelayBackgroundService> logger)
    {
    ...
    private async Task RelayBatch(CancellationToken cancellationToken)
    {
        ...
        {
            _logger.LogError(ex, "Failed to relay IdentityAccess outbox messages.");
        }
    }
}
