...
public class RenameShortlistCommandHandler : ICommandHandler<RenameShortlistCommand>
{
    ...
    public RenameShortlistCommandHandler(
    ...
    public async Task<Result> Handle(RenameShortlistCommand request, CancellationToken cancellationToken)
    {
        ...
        var renameResult = shortlist.Rename(request.NewName);
